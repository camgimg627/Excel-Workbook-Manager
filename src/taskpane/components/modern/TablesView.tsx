        ...
        <div className={styles.modalBackdrop}>
          <div className={styles.modal}>
            ...
            <div className={styles.modalGrid}>
              ...
              <div>
                ...
                <Select
                  ...
                  onChange={(_, data) => setBulkState((p) => ({ ...p, caseTransform: data.value as CaseTransform }))}
                >
            ...
            <div className={styles.modalActions}>
              ...
              <Button appearance="primary" disabled={submitting || bulkPreview.length === 0} onClick={() => void applyBulk()}>
                Apply
              </Button>
            </div>
          </div>
