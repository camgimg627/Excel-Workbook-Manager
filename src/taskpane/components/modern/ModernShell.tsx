...
const ModernShell: React.FC<ModernShellProps> = ({
  ...
  const navItems = useMemo<NavItem[]>(
    () => [
      ...
      { id: "watch",         label: "Watch Window",   icon: <Eye20Regular />,             enabled: true },
    ...
    <div className={styles.root}>
        ...
        {menuOpen ? (
          <div className={styles.menuPopover}>
            <button
              ...
              onClick={() => { onTargetChange("settings"); setMenuOpen(false); }}
            >
            ...
            <button
              type="button"
              className={styles.menuBtn}
              onClick={() => { onTargetChange("help"); setMenuOpen(false); }}
            >
            ...
            <button
              type="button"
              className={styles.menuBtn}
              onClick={() => { openLegacy(); setMenuOpen(false); }}
            >
              Open Legacy UI
            </button>
          </div>
      ...
      <div className={styles.main}>
        ...
        <div
          ...
          style={{
            width: expandedRail
              ? (isFormulaTarget ? "128px" : "160px")
              : isFormulaTarget ? "56px" : "72px",
          }}
        >
          {navItems.map((item) => {
            const selected =
        ...
        >
          ...
          {activeTarget === "watch" ? <WatchView /> : null}
